...
This is **Stellar's fork** of Cookiecutter Data Science with enhanced features for data science workflows. See the [Philosophy Document](STELLARS_CCDS_PHILOSOPHY.md) for design principles.
